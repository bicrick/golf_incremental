...
|-------|--------|----------|
| Camera angle | **Locked** | Harvest uses pre-IsoView 3D lock (`≈ -13.8° / 16.1° / 0°`) in `HARVEST_LOCKED_BASIS`. Bay editors stay 2:1 dimetric (`-26.565° / 45° / 0°`). See [01-camera-and-world.md](01-camera-and-world.md). |
