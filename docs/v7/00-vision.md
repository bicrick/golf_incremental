...
- Prestige button (Prestige tab) gated on cash on hand
...
| Parked (later / v8+) | Why |
|----------------------|-----|
| Landlord / escalating daily dues | Different game structure |
| Day-night real-time cycles | Scope |
| Field consumables / vacuum / whistle | Scope |
| Pay / Yardage “primers” | Weak prestige fantasy; buy those in-run anyway |
| Ratina / Rattling redesign | Needs its own pass; **hide** in v7 only |
| Full dual economy restructure (shop vs identity) | Overkill for first prestige |
