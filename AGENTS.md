...
1. Read the relevant doc from the [doc map](docs/README.md#doc-map). **New loop work:** [`docs/v2/README.md`](docs/v2/README.md). **Balance / long-tail progression:** [`docs/v3/README.md`](docs/v3/README.md). **Camera / world / buildable grid / crew bays:** [`docs/v4/README.md`](docs/v4/README.md).
