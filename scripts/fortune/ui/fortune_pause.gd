class_name FortunePause
extends Control
## v9 pause: resume, music / sound volume, back to title.
...
func _ready() -> void:
	...
	var keys := TourUi.label("Space swing / drop / roll\n1-4 rooms  Esc pause", 8, TourUi.INK_SOFT)
