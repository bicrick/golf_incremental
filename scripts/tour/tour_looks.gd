...
const LOOKS := {
	"barley": {
		...
		"darkness": 0.0,
		"sky": "f6c7a8",
		"props": [["g_pine", 5, 0.26], ["g_oak", 4, 0.3], ["barley_bush", 3, 0.3], ["barley_hay", 1, 0.3]],
		"bluff": ["8a6e52", "74593f", "4a3a30"],
		"weather": "pollen",
		"stripe": 10.0,
	},
	"cliffs": {
		...
		"darkness": 0.0,
		"sky": "9fd3ee",
		"props": [["g_cypress", 3, 0.3], ["cliffs_rock", 3, 0.5], ["cliffs_gorse", 4, 0.35]],
		"bluff": ["e2d6bc", "c9b99c", "8a7a66"],
		"weather": "spray",
		"sea_side": 58.0,
		"stripe": 12.0,
	},
	"mesa": {
		...
		"darkness": 0.0,
		"sky": "f0906a",
		"props": [["g_hoodoo", 3, 0.4], ["g_saguaro", 4, 0.3], ["mesa_rock", 3, 0.6], ["mesa_scrub", 3, 0.35]],
		"bluff": ["c8603c", "a44a30", "6a2c22"],
		"weather": "dust",
		"stripe": 14.0,
	},
	"frost": {
		...
		"darkness": 1.0,
		"sky": "1a2248",
		"props": [["g_frost_pine", 7, 0.3], ["frost_drift", 3, 0.5], ["frost_rock", 2, 0.4]],
		"bluff": ["e8eef8", "b8c6dc", "6a7a98"],
		"weather": "snow",
		"stripe": 14.0,
	},
	"edge": {
